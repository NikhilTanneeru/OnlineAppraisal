...
//   const reportFileInputRef = useRef(null); // Ref for the report file input 
...
//     const newScholars = [...scholars];
//     newScholars[index].scholarId = e.target.value;
//     setScholars(newScholars);
//   };
...
function Research({ activeTab, setActiveTab }) {
  ...
  const handleViewDetails = (research) => {
    setSelectedResearch(selectedResearch?.id === research.id ? research: null);
  };
            ...
            {researches.map((research, index) => (
              research.status === 'Approved' && (
                <React.Fragment key={index}>
                  ...
                  {selectedResearch && selectedResearch.id === research.id && (
                  <tr>
                      ...
                      <table className="w-full bg-white border border-gray-200">
                        <tbody>
                          <tr>
                            ...
                            <td className="border px-4 py-2">{selectedResearch.title}</td>
                          </tr>
                          <tr>
                            <td className="border px-4 py-2 font-bold">Start Date:</td>
                            <td className="border px-4 py-2">{selectedResearch.startDate}</td>
                          </tr>
                          <tr>
                            <td className="border px-4 py-2 font-bold">Expected End Date:</td>
                            <td className="border px-4 py-2">{selectedResearch.expectedEndDate}</td>
                          </tr>
                          <tr>
                            <td className="border px-4 py-2 font-bold">Scholars:</td>
                            <td className="border px-4 py-2">
                              <ul>
                                {selectedResearch.scholars.map((scholar, index) => (
                          ...
                          <tr>
                            ...
                            <td className="border px-4 py-2">{selectedResearch.reportFile.filename}</td>
                          </tr>
                        </tbody>
                      </table>
                    </td>
